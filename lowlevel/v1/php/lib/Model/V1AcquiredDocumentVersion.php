...
/**
 * V1AcquiredDocumentVersion Class Doc Comment
 *
 * @category Class
 ...
 */
class V1AcquiredDocumentVersion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1AcquiredDocumentVersion';
    ...
    protected static $openAPITypes = [
        ...
        'direction' => '\OpenAPI\Client\Model\V1DataTransferDirection',
        'upload_url' => 'string',
        'raw_file_url' => 'string',
    ...
    protected static $attributeMap = [
        ...
        'acquired_duration' => 'acquiredDuration'
    ];
    ...
    protected static $setters = [
        'document_version_id' => 'setDocumentVersionId',
        ...
        'acquired_duration' => 'setAcquiredDuration'
    ];
    ...
    protected static $getters = [
        ...
        'acquired_duration' => 'getAcquiredDuration'
    ];
    ...
    {
        $this->container['document_version_id'] = $data['document_version_id'] ?? null;
        ...
        $this->container['acquired_duration'] = $data['acquired_duration'] ?? null;
    }
    ...
    /**
     * Gets document_version_id
     *
     * @return string|null
     */
    public function getDocumentVersionId()
    {
        return $this->container['document_version_id'];
    }

    /**
     * Sets document_version_id
     *
     * @param string|null $document_version_id The ID of the document version.
     *
     * @return self
     */
    public function setDocumentVersionId($document_version_id)
    {
        $this->container['document_version_id'] = $document_version_id;
     ...
     * Gets direction
     *
     * @return \OpenAPI\Client\Model\V1DataTransferDirection|null
     */
     ...
     * Sets direction
     *
     * @param \OpenAPI\Client\Model\V1DataTransferDirection|null $direction direction
     *
     * @return self
     */
     ...
     * Sets acquired_by
     *
     * @param string|null $acquired_by The name of the worker that acquired the document version.
     *
     * @return self
     */
     ...
     * Sets acquired_time
     *
     * @param \DateTime|null $acquired_time The timestamp when the document version was acquired.
     *
     * @return self
     */
    ...
    /**
     * Gets acquired_duration
     *
     * @return string|null
     */
    public function getAcquiredDuration()
    {
        return $this->container['acquired_duration'];
    }

    /**
     * Sets acquired_duration
     *
     * @param string|null $acquired_duration The expected amount of time for task execution.
     *
     * @return self
     */
    public function setAcquiredDuration($acquired_duration)
    {
        $this->container['acquired_duration'] = $acquired_duration;
