...
#
package AbleSDK::Object::V1AcquiredDocumentVersion;
...
__PACKAGE__->class_documentation({description => 'Represents a DocumentVersion that has been acquired for processing.',
...
__PACKAGE__->method_documentation({
    ...
    'direction' => {
        datatype => 'V1DataTransferDirection',
        base_name => 'direction',
        description => '',
        format => '',
        read_only => '',
