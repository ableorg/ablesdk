...
namespace Able.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "v1DocumentContent")]
    public partial class V1DocumentContent : IEquatable<V1DocumentContent>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1DocumentContent" /> class.
        /// </summary>
        ...
        public V1DocumentContent(string externalPrimaryKey = default(string), List<V1Attribute> attributes = default(List<V1Attribute>))
        {
        ...
        {
            return this.Equals(input as V1DocumentContent);
        }

        /// <summary>
        /// Returns true if V1DocumentContent instances are equal
        /// </summary>
        /// <param name="input">Instance of V1DocumentContent to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1DocumentContent input)
        {
            if (input == null)
                return false;
