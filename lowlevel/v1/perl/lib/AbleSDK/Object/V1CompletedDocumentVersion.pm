...
#
package AbleSDK::Object::V1CompletedDocumentVersion;
...
__PACKAGE__->class_documentation({description => 'Represents a DocumentVersion that has been completed after processing.',
...
__PACKAGE__->method_documentation({
    ...
    'status' => {
        datatype => 'V1DocumentVersionStatus',
        base_name => 'status',
        description => '',
        format => '',
        read_only => '',
