...
#
package AbleSDK::Object::V1DocumentVersionStatus;
...
__PACKAGE__->class_documentation({description => 'Status of processing a document version.   - COMPLETE: Document processing has been successful.  - ERROR: Document processing was not successful.',
