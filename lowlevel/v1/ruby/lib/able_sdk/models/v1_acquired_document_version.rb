...
module AbleSDK
  ...
  class V1AcquiredDocumentVersion
    # The ID of the document version.
    attr_accessor :document_version_id
    ...
    attr_accessor :acquired_duration
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `AbleSDK::V1AcquiredDocumentVersion` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `AbleSDK::V1AcquiredDocumentVersion`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }

      if attributes.key?(:'document_version_id')
        self.document_version_id = attributes[:'document_version_id']
      end
      ...
      if attributes.key?(:'acquired_duration')
        self.acquired_duration = attributes[:'acquired_duration']
      end
    end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          acquired_duration == o.acquired_duration
    end
    ...
    def hash
      [document_version_id, external_primary_key, direction, upload_url, raw_file_url, standardized_pdf_url, content_url, acquired_by, acquired_time, acquired_duration].hash
    end
