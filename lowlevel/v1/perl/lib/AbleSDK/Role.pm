...
has _cfg => ( is => 'ro',
              isa => 'AbleSDK::Configuration',
              default => sub { AbleSDK::Configuration->new() },
              );
...
sub _build_af {
    ...
    return AbleSDK::ApiFactory->new(%args);
}
...
=head2 Able API version: 1.20230623221606
