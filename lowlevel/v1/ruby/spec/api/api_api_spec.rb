...
describe 'APIApi' do
  ...
  # unit tests for a_pi_acquire_document_version
  ...
  describe 'a_pi_acquire_document_version test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for a_pi_complete_document_version
  ...
  # @param document_version_id The ID of the document version that was processed.
  # @param properties 
  # @param [Hash] opts the optional parameters
  # @return [V1CompletedDocumentVersion]
  describe 'a_pi_complete_document_version test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end

  # unit tests for a_pi_create_document_version
  ...
  describe 'a_pi_create_document_version test' do
    it 'should work' do
      # assertion here. ref: https://www.relishapp.com/rspec/rspec-expectations/docs/built-in-matchers
    end
  end
