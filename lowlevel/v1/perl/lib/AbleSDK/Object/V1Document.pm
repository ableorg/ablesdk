...
#
package AbleSDK::Object::V1Document;
...
__PACKAGE__->class_documentation({description => 'Represents a document to be added to a DocumentContent.',
                                  class => 'V1Document',
                                  required => [], # TODO
}                                 );
