...
public class ApiApi {
     ...
     */
    public okhttp3.Call aPICreateDocumentContentV1Call(String extensionId, InlineObject body, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = body;
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call aPICreateDocumentContentV1ValidateBeforeCall(String extensionId, InlineObject body, final ApiCallback _callback) throws ApiException {
     ...
     */
    public V1DocumentContent aPICreateDocumentContentV1(String extensionId, InlineObject body) throws ApiException {
     ...
     */
    public ApiResponse<V1DocumentContent> aPICreateDocumentContentV1WithHttpInfo(String extensionId, InlineObject body) throws ApiException {
     ...
     */
    public okhttp3.Call aPICreateDocumentContentV1Async(String extensionId, InlineObject body, final ApiCallback<V1DocumentContent> _callback) throws ApiException {
