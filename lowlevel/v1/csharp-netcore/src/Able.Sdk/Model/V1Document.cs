...
namespace Able.Sdk.Model
{
    ...
    public partial class V1Document : IEquatable<V1Document>, IValidatableObject
    {
        ...
        /// <param name="prettyName">The pretty name of the document..</param>
        public V1Document(string externalPrimaryKey = default(string), List<V1Attribute> attributes = default(List<V1Attribute>), string prettyName = default(string))
        {
        ...
        /// </summary>
        /// <value>The pretty name of the document.</value>
        [DataMember(Name = "prettyName", EmitDefaultValue = false)]
        ...
        public bool Equals(V1Document input)
        {
            ...
            return 
                ...
                (
                    this.PrettyName == input.PrettyName ||
                    (this.PrettyName != null &&
                    this.PrettyName.Equals(input.PrettyName))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.PrettyName != null)
                    hashCode = hashCode * 59 + this.PrettyName.GetHashCode();
                return hashCode;
            }
        }
