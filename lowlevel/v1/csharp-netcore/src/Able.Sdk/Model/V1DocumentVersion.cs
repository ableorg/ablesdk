...
namespace Able.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "v1DocumentVersion")]
    public partial class V1DocumentVersion : IEquatable<V1DocumentVersion>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1DocumentVersion" /> class.
        /// </summary>
        ...
        public V1DocumentVersion(string externalPrimaryKey = default(string), List<V1Attribute> attributes = default(List<V1Attribute>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class V1DocumentVersion {\n");
        ...
        {
            return this.Equals(input as V1DocumentVersion);
        }

        /// <summary>
        /// Returns true if V1DocumentVersion instances are equal
        /// </summary>
        /// <param name="input">Instance of V1DocumentVersion to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1DocumentVersion input)
        {
            if (input == null)
                return false;
