...
namespace Able.Sdk.Api
{
    ...
    public interface IAPIApiSync : IApiAccessor
    {
        ...
        ApiResponse<V1DocumentContent> APICreateDocumentContentV1WithHttpInfo(string extensionId, V1CreateDocumentContentRequestV1Body body);
    ...
    public interface IAPIApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<V1DocumentContent> APICreateDocumentContentV1Async(string extensionId, V1CreateDocumentContentRequestV1Body body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<V1DocumentContent>> APICreateDocumentContentV1WithHttpInfoAsync(string extensionId, V1CreateDocumentContentRequestV1Body body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class APIApi : IAPIApi
    {
        ...
        /// <param name="body"></param>
        /// <returns>V1DocumentContent</returns>
        public V1DocumentContent APICreateDocumentContentV1(string extensionId, V1CreateDocumentContentRequestV1Body body)
        {
        ...
        /// <param name="body"></param>
        /// <returns>ApiResponse of V1DocumentContent</returns>
        public Able.Sdk.Client.ApiResponse<V1DocumentContent> APICreateDocumentContentV1WithHttpInfo(string extensionId, V1CreateDocumentContentRequestV1Body body)
        {
            // verify the required parameter 'extensionId' is set
            if (extensionId == null)
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of V1DocumentContent</returns>
        public async System.Threading.Tasks.Task<V1DocumentContent> APICreateDocumentContentV1Async(string extensionId, V1CreateDocumentContentRequestV1Body body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (V1DocumentContent)</returns>
        public async System.Threading.Tasks.Task<Able.Sdk.Client.ApiResponse<V1DocumentContent>> APICreateDocumentContentV1WithHttpInfoAsync(string extensionId, V1CreateDocumentContentRequestV1Body body, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            // verify the required parameter 'extensionId' is set
            if (extensionId == null)
                throw new Able.Sdk.Client.ApiException(400, "Missing required parameter 'extensionId' when calling APIApi->APICreateDocumentContentV1");
