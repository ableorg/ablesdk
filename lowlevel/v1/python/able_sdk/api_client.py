...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = APIApi()
        api_instance.a_pi_create_relationship  # this is an instance of the class Endpoint
        api_instance.a_pi_create_relationship()  # this invokes api_instance.a_pi_create_relationship.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.a_pi_create_relationship.callable or self.callable in this class
