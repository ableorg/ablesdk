...
namespace Able.Sdk.Model
{
    ...
    public partial class InlineObject : IEquatable<InlineObject>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="documents">A list of documents to be added to the DocumentVersion..</param>
        public InlineObject(List<V1Document> documents = default(List<V1Document>))
        {
        ...
        /// </summary>
        /// <value>A list of documents to be added to the DocumentVersion.</value>
