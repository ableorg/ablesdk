...
/**
 * V1CompletedDocumentContentV1 Class Doc Comment
 *
 * @category Class
 ...
 */
class V1CompletedDocumentContentV1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1CompletedDocumentContentV1';
    ...
    protected static $openAPITypes = [
        ...
        'status' => '\OpenAPI\Client\Model\V1DocumentContentStatusV1',
        'last_error' => 'string',
        'acquired_by' => 'string',
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\V1DocumentContentStatusV1|null
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\V1DocumentContentStatusV1|null $status status
     *
     * @return self
     */
     ...
     * Sets completed_by
     *
     * @param string|null $completed_by The name of the worker that completed the document content.
     *
     * @return self
     */
     ...
     * Sets completed_time
     *
     * @param \DateTime|null $completed_time The timestamp when the document content was completed.
     *
     * @return self
     */
