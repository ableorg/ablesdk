...
module AbleSDK
  ...
  class V1AcquiredDocumentContentV1
    ...
    def hash
      [document_content_id, external_primary_key, direction, upload_url, raw_file_url, standardized_pdf_url, content_url, acquired_by, acquired_time, next_retry_time, task_type, attributes].hash
    end
