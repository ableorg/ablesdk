 ...
 */
class V1UploadRef implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'v1UploadRef';
     ...
     * Sets upload_url
     *
     * @param string $upload_url URL where the file contents should be PUT.
     *
     * @return self
     */
