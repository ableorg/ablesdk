...
namespace Able.Sdk.Model
{
    ...
    /// </summary>
    [DataContract(Name = "v1AcquiredDocumentContentV1")]
    public partial class V1AcquiredDocumentContentV1 : IEquatable<V1AcquiredDocumentContentV1>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="V1AcquiredDocumentContentV1" /> class.
        /// </summary>
        ...
        /// <param name="nextRetryTime">The expected time of task compleation. If not completed before this time, the task will be retried..</param>
        /// <param name="taskType">taskType.</param>
        /// <param name="attributes">attributes.</param>
        public V1AcquiredDocumentContentV1(string documentContentId = default(string), string externalPrimaryKey = default(string), V1DataTransferDirectionV1 direction = default(V1DataTransferDirectionV1), string uploadUrl = default(string), string rawFileUrl = default(string), string standardizedPdfUrl = default(string), string contentUrl = default(string), string acquiredBy = default(string), DateTime acquiredTime = default(DateTime), DateTime nextRetryTime = default(DateTime), string taskType = default(string), List<V1Attribute> attributes = default(List<V1Attribute>))
        {
        ...
        public V1DataTransferDirectionV1 Direction { get; set; }
        ...
        /// </summary>
        /// <value>The expected time of task compleation. If not completed before this time, the task will be retried.</value>
        [DataMember(Name = "nextRetryTime", EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  NextRetryTime: ").Append(NextRetryTime).Append("\n");
        ...
        {
            return this.Equals(input as V1AcquiredDocumentContentV1);
        }

        /// <summary>
        /// Returns true if V1AcquiredDocumentContentV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of V1AcquiredDocumentContentV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(V1AcquiredDocumentContentV1 input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.NextRetryTime == input.NextRetryTime ||
                    (this.NextRetryTime != null &&
                    this.NextRetryTime.Equals(input.NextRetryTime))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.NextRetryTime != null)
                    hashCode = hashCode * 59 + this.NextRetryTime.GetHashCode();
