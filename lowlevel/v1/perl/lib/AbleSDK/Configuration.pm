...
=head1 Name
        ...
        AbleSDK::Configuration - holds the configuration for all AbleSDK Modules
...
sub new {
    ...
    # base_url
    $p{base_url} //= 'https://api.ableai.com';
